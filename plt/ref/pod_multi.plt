...
set format x '$$'
set format cb '$%.2f$'
set cblabel '{\Large $\frac{\sqrt{u^2+v^2}}{u_\theta^{wall}}$}' offset 1
...
plot infile1 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""

#################################################################################

set label 31 at graph 0.02,1.12 '(b)~mode2' front

set tmargin screen 0.845
set bmargin screen 0.690


plot infile2 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""
...
set tmargin screen 0.690
set bmargin screen 0.535


plot infile3 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""
...
set bmargin screen 0.380


plot infile4 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""
...
set tmargin screen 0.380
set bmargin screen 0.225


plot infile5 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""
...
plot infile6 every ev:ev:3 using ($1/64):(($2-0.111111)/64):($4*adj):($5*adj):(sqrt($4*$4+$5*$5)) with vectors linecolor palette linewidth 3 title ""
