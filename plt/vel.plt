...
plot \
"data/sol_xyuv.tsv" using ($1):($2):($3*adj):($4*adj):(sqrt($3*$3+$4*$4)) every aaaa:bbbb with vector linecolor 'black' linewidth 2.4 title "" ,\
...
plot \
"data/bub_xyuv.tsv" using ($1):($2):($3*adj):($4*adj):(sqrt($3*$3+$4*$4)) every aaaa:bbbb with vector linecolor 'black' linewidth 2.4 title "" ,\
